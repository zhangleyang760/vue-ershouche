<template>
  <div id="seller">
    ...
    <div id="city"> 城市：<el-select size="small" style="width: 600px"
    ...
    <div id="idcard"> 身份证号：<el-input  v-model="seller.idcard" style="width: 600px"></el-input><br></div>
    <div id="phone"> 手机号：<el-input  v-model="seller.phone" style="width: 600px"></el-input><br></div>
    <div id="sex"> 性别：<el-input  v-model="seller.sex" style="width: 600px"></el-input><br></div>
    <div id="email">邮箱：<el-input  v-model="seller.email" style="width: 600px"></el-input><br></div>
